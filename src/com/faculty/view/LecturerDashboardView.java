...
public class LecturerDashboardView extends JFrame {
    ...
    private void initUI() {
        ...
        String dispName = lecturer != null ? lecturer.getFullName() : user.getUsername();
        JLabel userLabel = new JLabel("Lecturer: " + dispName);
    ...
    private JPanel buildSidebar() {
        ...
        JLabel logoSubText = new JLabel("LECTURER PORTAL");
        logoSubText.setFont(new Font("Segoe UI", Font.BOLD, 9));
        logoSubText.setForeground(UITheme.SECONDARY);
